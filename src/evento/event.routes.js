...
//Routes from Event
api.post('/addEvent', validateJwt, createEventValidator, createEvent) //Create Event
api.put('/updateEvent/:id', updateHotelValidator, validateJwt, updateEvent) //Update Event
